            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-image mt-50 clearfix">
                        ...
                        <div data-aos="fade-right" class="about-btn">
                            <a class="main-btn" href="#"><span>Berdiri Sejak</span> 2004 </a>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-45">
                        <h4 class="about-welcome">Tengtang Kami </h4>
                        <h3 class="about-title mt-10">SATELIT GSJA GETSEMANI</h3>
    ...
    <section id="team" class="team-area pt-125 pb-130 gray-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center pb-20">
                        <h5 class="sub-title mb-15">Pendeta Gereja</h5>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row">
